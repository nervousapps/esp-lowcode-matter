...
int app_driver_init()
{
    ...
    system_set_pin_mode(SENSOR_PIN, INPUT);
    contact_state = system_digital_read(SENSOR_PIN);
    return 0;
}
...
bool set_contact_state(int state) {
    /* Update the contact sensor feature */
    low_code_feature_data_t update_data = {
        .details = {
            .endpoint_id = 1,
            .low_level{
                .matter{
                    .cluster_id = 69,            /*!< Matter cluster ID */
